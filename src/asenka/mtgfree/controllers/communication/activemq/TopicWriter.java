...
final class TopicWriter extends AbstractActiveMQCommunicator {
	 ...
	 * @throws CommunicationException if the connection with the broker cannot be initialized properly
	 */
	TopicWriter(String brokerUrl, String topicId) throws CommunicationException {
	 ...
	 */
	void publish(final Serializable data) throws CommunicationException {
	 ...
	 */
	@Override
	public void close() throws RuntimeErrorException {
