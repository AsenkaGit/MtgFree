...
//		final Player player = new Player(1, "Player_1");
//		final GameController gameController = new GameController(new GameTable("Main", player));
//		gameController.createGame();
		final Player player = new Player(2, "Player_2");
		final GameController gameController = new GameController(new GameTable("Main", player));
