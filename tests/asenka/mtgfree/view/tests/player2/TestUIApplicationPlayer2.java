...
public class TestUIApplicationPlayer2 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.setTitle("Mtg Free [TEST GAME] - Player 2");
	...
	private void initRootLayout() {
		...
		try {
			...
			loader.setLocation(TestUIApplicationPlayer2.class.getResource("TestGameApplicationPlayer2.fxml"));
